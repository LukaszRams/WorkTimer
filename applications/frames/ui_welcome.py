...
class Ui_WelcomeFrame:
    def setupUi(self, WelcomeFrame):
        ...
        self.signin_btn = QtWidgets.QPushButton(self.canvas)
        ...
        self.signin_btn.setBaseSize(QtCore.QSize(100, 10))
        self.signin_btn.setObjectName("signin_btn")
        self.btn_layout.addWidget(self.signin_btn)
    ...
    def retranslateUi(self, WelcomeFrame):
        ...
        self.signin_btn.setText(_translate("WelcomeFrame", "SIGN IN"))
